...
![](https://github.com/pnojai/dskill/blob/dev/docs/2019-Bar-Plot.JPG)

- Most commonly used skill within Data Scientists is Data Analysis.

- Top 3 General Data Science Skills are Data Analysis, Statistics and Machine Learning.

- R is the most commonly used Programming Language followed by Python and SQL.

![](https://github.com/pnojai/dskill/blob/dev/docs/2018-Bar-Plot.JPG)

- Most commonly used skill within Data Scientists is Machine Learning.

- Top 3 General Data Science Skils are Machine Learning, Data Analysis and Statistics. 
 
- Conclusion.

- Top General Data Science Skills are same for 2018 Jeff Hale's Analysis and Our Analysis. 
